...
BOT_USERNAME = environ.get("BOT_USERNAME", "Instagram_Viral_Post_Bot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://Razith7866:Razith786@cluster0.rpema.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = environ.get("DB_NAME", "Mariafiles")
...
# Website Info:
WEBSITE_URL_MODE = bool(environ.get('WEBSITE_URL_MODE', Flse)) # Set True or False
